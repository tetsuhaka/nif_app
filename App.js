...
function TimerScreen() {
  ...
  return (
    <SafeAreaView style={{
      ...
      <ImageBackground source = {require('./img/timer.png')} style = {{width:'100%',height:'100%' }}>
            <View style ={{width:'100%',height:'10%',backgroundColor: 'hsla(0,0%,0%,0)'}}></View>
      <TouchableOpacity
  ...
  return (
    <NavigationContainer>
      <Tab.Navigator>
        ...
        <Tab.Screen name="Settings" component={TimerScreen} />
      </Tab.Navigator>
    </NavigationContainer>
  );
}